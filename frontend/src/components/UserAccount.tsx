      ...
      {isOpen && (
        <div className="absolute right-0 mt-3 w-[260px] bg-black border border-gray-800 rounded-md text-white shadow-lg z-50 divide-y divide-gray-700">
          ...
          <div className="p-2 space-y-2">
            <Link to="/user/dashboard/profile" className="flex items-center hover:text-gray-400">
              <CgProfile size={20} className="mr-2" />
              Profile
            </Link>
            <Link to="/user/dashboard/orders" className="flex items-center hover:text-gray-400">
