...
const filters = {
  quantity: ['50 g', '100 g', '150 g', '+ 7 more'],
  categories: [
    'Veg Masala',
    'South Indian',
    'Non Veg Masala',
    ...
    <div className="bg-black text-white min-h-screen px-4 py-6 sm:px-6 sm:py-8">
      ...
      <div className="flex gap-6">
        ...
        <aside className="w-60 bg-black text-white hidden sm:block">
          <h2 className="text-3xl font-semibold font-heading mb-4">Filters</h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-3 pt-4 text-white bg-[#141414]">
                    ...
                    <div className="text-xs text-gray-300 mt-1">{product.weight}</div>
                    ...
                    {quantity === 0 ? (
                      ...
                      <div className="mt-3 flex items-center justify-between bg-yellow-400 rounded-full px-3 py-1.5 text-black font-semibold text-sm">
                        <button onClick={() => addToCart(product.name)} className="px-2">+</button>
                        <span>{quantity}</span>
                        <button
                          onClick={() =>
                            setCart((prev) => {
                              ...
                              return { ...prev, [product.name]: current - 1 };
                            })
                          }
                          className="px-2"
                        >
